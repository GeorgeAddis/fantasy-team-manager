...
{
    protected $fillable = ['name', 'fantrax_id', 'teams_updated_at', 'requires_waiver_claim', 'requires_roster_moves', 'requires_roster_optimised', 'requires_thursday_update', 'requires_pre_season_optimised'];
